...
namespace Satis.ModelViewer.Modules.Startup
{
	public class Module : ModuleBase
	{
		protected override void Initialize()
		{
			...
			shell.OpenDocument(new ModelEditorViewModel(torusScene, "[New Shape]"));
		...
		{
			yield return Show.Document(new ModelEditorViewModel(Meshellator.CreateFromSphere(10, 10), "[New Sphere]"));
		}

		private static IEnumerable<IResult> NewTeapot()
		{
			yield return Show.Document(new ModelEditorViewModel(Meshellator.CreateFromTeapot(10, 10), "[New Teapot]"));
		}
