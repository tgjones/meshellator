...
public class Scene3ds
{
  ...
  // Array of meshes
  List<Mesh3ds> mMesh = new List<Mesh3ds>(5);

  // Array of cameras
  private List<Camera3ds> mCamera = new List<Camera3ds>(5);

  // Array of materials
  private List<Material3ds> mMaterial = new List<Material3ds>(5);

  // Array of lights
  private List<Light3ds> mLight = new List<Light3ds>(5);
  ...
  private string read_NAME(int length)  {
